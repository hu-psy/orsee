...
insert into ##new_db##.or_experiment_types(exptype_id, exptype_name, exptype_description, exptype_mapping, enabled) 
select exptype_id, exptype_name, exptype_description, exptype_mapping, enabled from ##old_db##.or_experiment_types;

delete from ##new_db##.or_lang where content_type='experiment_type';
update ##old_db##.or_lang set lang_id = lang_id + 220004 where content_type = "experiment_type";

insert into ##new_db##.or_lang(lang_id, enabled, content_type, content_name, en, de) 
select lang_id, enabled, content_type, content_name, en, de from ##old_db##.or_lang where content_type = "experiment_type";

/* add new types which combine payment, feedback and VP-hours */
/*insert into ##new_db##.or_experiment_types 
